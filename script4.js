...
window.addEventListener('load', handleScroll);
 ...
 icon.onclick = function(){
    if(mySong.paused){
        mySong.play();                                       /* 1st*/
        icon.src="images/avepausebtn.jpg";
    }
    else{
        mySong.pause();
        icon.src="images/aveplaybtn.jpg";
    }
 }
 ...
 png.onclick =function(){                                  /* 2nd*/
    if(mysongg.paused){
        mysongg.play();
        png.src="images/avepausebtn.jpg";
    }
    else{
        mysongg.pause();
        png.src="images/aveplaybtn.jpg";
    }
 }
 ...
 pngg.onclick =function(){
    if(mysonggg.paused){
        mysonggg.play();
        pngg.src="images/avepausebtn.jpg";
    }
    else{
        mysonggg.pause();
        pngg.src="images/aveplaybtn.jpg";
    }
 }
 ...
 pnggg.onclick =function(){
    if(myvoice.paused){
        myvoice.play();
        pnggg.src="images/avepausebtn.jpg";
    }
    else{
        myvoice.pause();
        pnggg.src="images/aveplaybtn.jpg";
    }
 }
 ...
 pngggg.onclick =function(){
    if(myvoices.paused){
        myvoices.play();
        pngggg.src="images/avepausebtn.jpg";
    }
    else{
        myvoices.pause();
        pngggg.src="images/aveplaybtn.jpg";
    }
 }
 ...
 pnggggg.onclick =function(){
    if(myvoicess.paused){
        myvoicess.play();
        pnggggg.src="images/avepausebtn.jpg";
    }
    else{
        myvoicess.pause();
        pnggggg.src="images/aveplaybtn.jpg";
    }
 }
 ...
 pngggggg.onclick =function(){
    if(myvoicesss.paused){
        myvoicesss.play();
        pngggggg.src="images/avepausebtn.jpg";
    }
    else{
        myvoicesss.pause();
        pngggggg.src="images/aveplaybtn.jpg";
    }
 }
